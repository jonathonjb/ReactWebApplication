  ...
  return (
    <div className="Home">
      <div className="container">
        ...
        <br/><br/>
        <div className="row">
            <img className="curved_images col-xs-12 col-md-2 offset-2" id="self_photo" src={SelfPhoto} alt="Jonathon Brandt" />
            <p className="col-xs-12 col-md-4 offset-2">
        ...
        <br/><br/>
        <div className="row">
            <p className="col-xs col-md-4 offset-1">
            ...
            <img className="col-xs-12 col-md-4 curved_images offset-1" src={CodePhoto} alt="Code" />
        </div>
      </div>
    </div>
  );
